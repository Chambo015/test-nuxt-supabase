    ...
    class: [
      ...
      // Primary Button
      {
        ...
        "bg-primary dark:bg-primary-400":
          !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
        "border-none border-primary-500 dark:border-primary-400":
          !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
      },
      // Primary Text Button
      {
      ...
      // Warning Button
      {
        "text-[#EF4444] dark:text-surface-900":
          props.severity === "warning" && !props.text && !props.outlined && !props.plain,
        "bg-[#FEE2E2] dark:bg-orange-400":
          props.severity === "warning" && !props.text && !props.outlined && !props.plain,
        "border border-[#FEE2E2] dark:border-orange-400":
          props.severity === "warning" && !props.text && !props.outlined && !props.plain,
      },
      // Warning Text Button
      {
      ...
      // Primary
      {
        "hover:bg-primary-hover dark:hover:bg-primary-300 hover:border-primary-600 dark:hover:border-primary-300":
          !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
      },
      {
      ...
      // Warning
      {
        "hover:bg-[#F1D1D1] dark:hover:bg-orange-300 hover:border-orange-600 dark:hover:border-orange-300":
          props.severity === "warning" && !props.text && !props.outlined && !props.plain,
      },
      {
